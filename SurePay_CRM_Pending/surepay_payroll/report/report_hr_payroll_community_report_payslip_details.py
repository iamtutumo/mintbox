...
class ReportHrPayrollCommunityReportPayslipDetails(models.AbstractModel):
    ...
    _name = 'report.surepay_payroll.report_payslipdetails'
    ...
    def get_details_by_rule_category(self, payslip_lines):
        ...
        PayslipLine = self.env['surepay_payroll.hr.payslip.line']
        RuleCateg = self.env['surepay_payroll.hr.salary.rule.category']
        ...
        if payslip_lines:
            self.env.cr.execute("""
                ...
                surepay_payroll_hr_payslip_line as pl
                LEFT JOIN surepay_payroll_hr_salary_rule_category AS rc on 
    ...
    def _get_report_values(self, docids, data=None):
        ...
        payslips = self.env['surepay_payroll.hr.payslip'].browse(docids)
        return {
            'doc_ids': docids,
            'doc_model': 'surepay_payroll.hr.payslip',
            'docs': payslips,
            'data': data,
