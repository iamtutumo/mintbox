...
class HrSalaryRuleCategory(models.Model):
    ...
    _name = 'surepay_payroll.hr.salary.rule.category'
    ...
    parent_id = fields.Many2one('surepay_payroll.hr.salary.rule.category',
                                string='Parent',
                                help="Linking a salary category to its parent"
                                     "is used only for the reporting purpose.")
    children_ids = fields.One2many('surepay_payroll.hr.salary.rule.category',
                                   'parent_id',
                                   string='Children',
