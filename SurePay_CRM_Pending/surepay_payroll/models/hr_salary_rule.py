...
class HrSalaryRule(models.Model):
    ...
    _name = 'surepay_payroll.hr.salary.rule'
    _order = 'sequence, id'
    ...
    category_id = fields.Many2one('surepay_payroll.hr.salary.rule.category',
                                  string='Category',
    ...
    appears_on_payslip = fields.Boolean(string='Appears on Payslip',
                                        ...
                                        help="Used to display the salary"
                                             "rule on payslip.")
    parent_rule_id = fields.Many2one('surepay_payroll.hr.salary.rule',
    ...
    amount_percentage_base = fields.Char(string='Percentage based on',
                                         help='result will be affected to a '
                                              'variable')
    child_ids = fields.One2many('surepay_payroll.hr.salary.rule',
                                'parent_rule_id',
    ...
    input_ids = fields.One2many('surepay_payroll.hr.rule.input',
    ...
    structure_ids = fields.Many2many('surepay_payroll.hr.payroll.structure',
                                   'surepay_payroll_structure_rel', 'rule_id',
