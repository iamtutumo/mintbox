...
class HrPayrollStructure(models.Model):
    ...
    - Deductions
    """
    _name = 'surepay_payroll.hr.payroll.structure'
    ...
    parent_id = fields.Many2one('surepay_payroll.hr.payroll.structure',
                                string='Parent',
                                default=_get_parent,
                                help="Choose Payroll Structure")
    children_ids = fields.One2many('surepay_payroll.hr.payroll.structure',
                                   'parent_id',
                                   string='Children', copy=True,
                                   help="Choose Payroll Structure")
    rule_ids = fields.Many2many('surepay_payroll.hr.salary.rule',
                                'surepay_payroll_structure_rel', 'struct_id',
