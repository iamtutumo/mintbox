...
class ResConfigSettings(models.TransientModel):
    ...
    module_l10n_fr_surepay_payroll = fields.Boolean(string='French Payroll',
                                               help="Is French Payroll")
    module_l10n_be_surepay_payroll = fields.Boolean(string='Belgium Payroll',
                                               help="Is Belgium Payroll")
    module_l10n_in_surepay_payroll = fields.Boolean(string='Indian Payroll',
